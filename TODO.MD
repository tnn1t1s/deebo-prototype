...
- add to prompt tell mother agent to verify solution first before returning it only 95% confidence or higher
- change file system mcp to desktop commander so agents can run code
